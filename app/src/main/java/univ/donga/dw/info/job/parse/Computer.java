...
// 컴퓨터공학과
public class Computer extends BaseParser{
	
	public static String listUrl = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=2&board_id=2&client_id=computer&site_id=computer&curPage=1&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=&command=list&warning_yn=N&category_id=0&category_depth=";
	public static String boardUrlFront = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=2&board_id=2&client_id=computer&site_id=computer&curPage=2&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=";// 게시글 번호기준 url 앞부분
	public static String boardUrlLast = "&command=view&warning_yn=N&category_id=0&category_depth="; // 게시글 번호기준 url 뒷부분
	private URL mUrl;
    ...
    public ArrayList<JobBoardInfo> getList(int pageNumber){
    	listUrl = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=2&board_id=2&client_id=computer&site_id=computer&curPage="+pageNumber+"&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=&command=list&warning_yn=N&category_id=0&category_depth=";
    	try {

...
// 신소재공학과
public class Metal extends BaseParser{
	
	public static String listUrl = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=3&board_id=3&client_id=metal&site_id=metal&curPage=1&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=&command=list&warning_yn=N&category_id=0&category_depth=";
	public static String boardUrlFront = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=3&board_id=3&client_id=metal&site_id=metal&curPage=1&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=";
    ...
    public ArrayList<JobBoardInfo> getList(int pageNumber){
    	listUrl = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=3&board_id=3&client_id=metal&site_id=metal&curPage="+pageNumber+"&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=&command=list&warning_yn=N&category_id=0&category_depth=";
    	try {

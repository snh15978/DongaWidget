...
// 산업경영공학과
public class Ie extends BaseParser{
	
	public static String listUrl = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=2&board_id=2&client_id=ise&site_id=ise&curPage=1&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=&command=list&warning_yn=N&category_id=0&category_depth=";
	public static String boardUrlFront = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=2&board_id=2&client_id=ise&site_id=ise&curPage=1&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=";
    ...
    public ArrayList<JobBoardInfo> getList(int pageNumber){
    	listUrl = "http://cms.donga.ac.kr/servlet/kr.co.k2web.jwizard.contents.board.boardUser.servlet.userMainServlet?handle=2&board_id=2&client_id=ise&site_id=ise&curPage="+pageNumber+"&search=&column=&catecolumn=&catesearch=&b_type=01&list_type=01&board_seq=&command=list&warning_yn=N&category_id=0&category_depth=";
    	try {

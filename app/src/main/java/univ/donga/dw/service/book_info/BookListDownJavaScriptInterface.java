...
public class BookListDownJavaScriptInterface {
	...
	public BookListDownJavaScriptInterface(BookListServiceManager bookListServiceManager, Handler mAfterDown)
	{
	...
	public void downBookPosibleExtend(String html) {
		...
		//리스트에 추가한다.
		bookListServiceManager.getBookListManager().addBookList(bookInfo);
	}
	//파싱이 끝낫음을 알린다.
